...
struct Material {
    Material(float _index, const Vector & _ambient, const Vector & _diffuse, const Vector & _specular, float _shininess):
        ambient(_ambient), diffuse(_diffuse), specular(_specular), shininess(_shininess), refractive_index(_index){}
    Material(){}
